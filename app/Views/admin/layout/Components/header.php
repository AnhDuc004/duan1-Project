...
<head>
    ...
    <link href="<?= URL?>/Public/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?= URL?>/Public/styles/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="<?= URL?>/Public/styles/css/admin.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= URL?>">
                ...
                <div class="sidebar-brand-text mx-3">Trang Chu</div>
            </a>
